package src.test.java.no.oslomet.cs.algdat;

import org.junit.jupiter.api.Test;
import src.main.java.no.oslomet.cs.algdat.DobbeltLenketListe;
import src.main.java.no.oslomet.cs.algdat.Liste;
...
class Oppgave0Test {
    ...
    void gruppeMedlemmerOppdatert() {
        assertNotEquals(String.valueOf(0), DobbeltLenketListe.gruppeMedlemmer(), "Oppdater funksjonen gruppeMedlemmer() så den returnerer antall personer i gruppa!");
    }
}
